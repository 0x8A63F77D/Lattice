...
**Shape.** Ship only the invariant-neutral half: intent-gated enter fades (Part 2's enter column) on holders' `IsEntering`, recycle-safe per C2, plus the reduce-motion gate. Exit motion: not built; #112's exit half closes as won't-build.
